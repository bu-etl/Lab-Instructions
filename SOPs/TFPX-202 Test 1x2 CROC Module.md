...
<img src="TFPX-202-materials/images/line_closed.png" width="300" alt="Foo diagram"> <br> Begin cooling the coolant in the chiller. Turn the chiller on using the red button on the chiller. <br>
<img src="TFPX-202-materials/images/chiller_power.png" width="300" alt="Foo diagram"> <br> Using the dial, highlight "Setpoint", and press the dial in to select. Using the dial, select 10.0 degrees Celsius as the setpoint. Press the dial to select. <br> <img src="TFPX-202-materials/images/chiller_menu.png" width="300" alt="Foo diagram"> <img src="TFPX-202-materials/images/setpoint_menu_10C.jpg" width="300" alt="Foo diagram"> <br>  Select the power button in the top-right corner using the dial and press to start chilling the coolant. The chiller will go from "Standby" to "On". <br> <img src="TFPX-202-materials/images/chiller_on1_10C.jpg" width="300" alt="Foo diagram"> <img src="TFPX-202-materials/images/chiller_on2_10C.jpg" width="300" alt="Foo diagram">
...
6. You will also need to open the valve on the air flow meter attached to the side of the coldbox. 8 SCFH is a suitable flow rate while bringing the dew point of the coldbox below 10°C. You should reduce the flow rate to about 2.5 SCFH once the dew point is comfortably below 10°C to save dry air while also maintainig the proper humidity. <br> <img src="TFPX-202-materials/images/8scfh.png" width="300" alt="Foo diagram"> <img src="TFPX-202-materials/images/2p5scfh.png" width="300" alt="Foo diagram"> <br>
7. Wait for the dew point to reach comfortably below 10°C. Then you may open the coolant valve to begin chilling the module.
8. Set the peltier target temperature to 10.00°C in the Peltier Controller menu on the main page of the GUI. Be sure to click "Set Temperature". Verfiy that "Current Set Temp" reads 10.0. ![alt text](TFPX-202-materials/images/set_temp_10C.png) Click "Peltier Power On/Off" when the peltier temperature is below 15°C. The red icon next to the current set temp will turn green. You should see the temperature of the peltier rapidly drop to about 10°C. The temperature may oscillate about ±0.5°C around 10°C. This is normal.
